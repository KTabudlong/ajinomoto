  ...
  return (
    <div className="flex items-center justify-between w-full p-4 text-sm bg-white border-b md:py-0 md:px-12 d:text-md">
      <div className="mt-1 mr-4">
        {ucwords(import.meta.env.VITE_APP_NAME.replaceAll("_", " "))}
      </div>
        ...
        >
          <div className="flex items-center gap-2 mr-2">
            <Link
              ...
              className="px-2 py-0.5 rounded-full bg-blue-100 text-blue-700 text-xs font-semibold hover:bg-blue-200 transition"
              title="Click to change your timezone"
              onClick={(e) => e.stopPropagation()}
            >
              {auth.user.timezone || "America/Chicago"}
            </Link>
            <a
              href={route("home")}
              target="_blank"
